...
public abstract class StatefulActivity<STATE_TYPE extends BaseState<STATE_TYPE>>
    ...
    public void onStateSetStart(STATE_TYPE state) {
        ...
        if (state.hasFlag(FLAG_CLOSE_POPUPS)) {
            AbstractFloatingView.closeAllOpenViews(this, !state.hasFlag(BaseState.FLAG_NON_INTERACTIVE));
        }
    }
    ...
    private void handleDeferredResume() {
        if (hasBeenResumed() && !getStateManager().getState().hasFlag(BaseState.FLAG_NON_INTERACTIVE)) {
