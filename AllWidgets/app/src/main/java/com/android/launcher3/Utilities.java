...
public final class Utilities {
    ...
    public static final Person[] EMPTY_PERSON_ARRAY = (Build.VERSION.SDK_INT >= VERSION_CODES.Q) ? new Person[0]
            : null;

    public static final boolean ATLEAST_O = Build.VERSION.SDK_INT >= VERSION_CODES.O;

    public static final boolean ATLEAST_O_MR1 = Build.VERSION.SDK_INT >= VERSION_CODES.O_MR1;
